...
const BooksPage = () => {
  const handlePayPalPurchase = (bookTitle, price) => {
    ...
    const paypalUrl = `https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=${encodeURIComponent(
      paypalEmail
    )}&item_name=${encodeURIComponent(bookTitle)}&amount=${price}&shipping=${shippingCost}&currency_code=USD`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                August 23rd was just an ordinary day for some, but for Florida Peppermint, this was the most exciting day of her entire life.
              </p>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Florida discovers that no matter what happens, her father is always near. All she has to do is listen for his voice!
              </p>
              <p className="text-burgundy font-bold mb-4">Comes with a FREE coloring book!</p>
              <div className="flex justify-between items-center mb-4">
